...
7. Presentasikan model yang telah dibuat pada P2W2D3AM.
...
| Criteria | Meet Expectations | Points |
| --- | --- | --- |
| Model Deployment | Membuat webapps terhadap project yang telah dibuat. | 10 pts (menggunakan TF Serving), <br><br> 5 pts (menggunakan flask) |
